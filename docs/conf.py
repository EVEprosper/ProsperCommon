...
# -*- coding: utf-8 -*-
#
# ProsperCommon documentation build configuration file, created by
...
htmlhelp_basename = 'ProsperCommondoc'
...
latex_documents = [
    (master_doc, 'ProsperCommon.tex', 'ProsperCommon Documentation',
     'John Purcell', 'manual'),
]
...
man_pages = [
    (master_doc, 'prospercommon', 'ProsperCommon Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ProsperCommon', 'ProsperCommon Documentation',
     author, 'ProsperCommon', 'One line description of project.',
     'Miscellaneous'),
]
